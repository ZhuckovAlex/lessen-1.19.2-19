...
public class ModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == VillagerProfession.LIBRARIAN) {
            ...
            ItemStack stack = new ItemStack(Items.ENCHANTED_BOOK, 1); //Продаю 5 хлопка
            Enchantment enchantment = Enchantments.MENDING; // Добавить класс
        ...
        if(event.getType() == VillagerProfession.LIBRARIAN) {
            ...
            int villagerLevel = 1; //Уровень жителя
            trades.get(villagerLevel).add((trader, rand) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 20), // 2 Изумруда
                    stack,10,500,0.02F));
        }
